...
public sealed partial class ProblemMapping(ILogger<ProblemMapping> logger) : IExceptionHandler
{
    ...
    private static int StatusCode(string errorCode) => errorCode switch
    {
        ...
        ErrorCodes.ConfigFileMissing or ErrorCodes.WorkflowNotFound or ErrorCodes.ProjectNotFound or ErrorCodes.ProjectLaunchMissing => StatusCodes.Status404NotFound,
